export const INITIAL_TIRES = [
  { id:1,  brand:"Michelin",    name:"Pilot Sport 5",          width:"225", aspect:"45", rim:"17", type:"Θερινό", price:189, fuel:"A", wet:"A", noise:70, load:91,  speed:"Y", stock:12 },
  { id:2,  brand:"Continental", name:"PremiumContact 7",       width:"225", aspect:"45", rim:"17", type:"Θερινό", price:165, fuel:"B", wet:"A", noise:71, load:91,  speed:"W", stock:7  },
  { id:3,  brand:"Bridgestone", name:"Turanza T005",           width:"225", aspect:"45", rim:"17", type:"Θερινό", price:152, fuel:"B", wet:"B", noise:72, load:91,  speed:"V", stock:0  },
  { id:4,  brand:"Pirelli",     name:"P Zero",                 width:"225", aspect:"45", rim:"17", type:"Θερινό", price:210, fuel:"A", wet:"A", noise:69, load:94,  speed:"Y", stock:4  },
  { id:5,  brand:"Goodyear",    name:"Eagle F1 Asymmetric 6",  width:"225", aspect:"45", rim:"17", type:"Θερινό", price:178, fuel:"A", wet:"A", noise:70, load:91,  speed:"Y", stock:19 },
  ...
  { id:12, brand:"Hankook",     name:"Ventus S1 evo3",         width:"245", aspect:"40", rim:"19", type:"Θερινό", price:155, fuel:"B", wet:"A", noise:70, load:98,  speed:"Y", stock:14 },
  { id:13, brand:"Dunlop",      name:"Sport Maxx RT2",         width:"245", aspect:"45", rim:"18", type:"Θερινό", price:142, fuel:"C", wet:"B", noise:71, load:100, speed:"Y", stock:5  },
  { id:14, brand:"Falken",      name:"Azenis FK520",           width:"215", aspect:"55", rim:"17", type:"Θερινό", price:99,  fuel:"B", wet:"A", noise:70, load:98,  speed:"W", stock:9  },
  ...
  { id:16, brand:"Toyo",        name:"Proxes Sport",           width:"235", aspect:"45", rim:"18", type:"Θερινό", price:132, fuel:"C", wet:"B", noise:72, load:98,  speed:"Y", stock:1  },
...
export const BRAND_ICONS = {
  ...
  Goodyear:"🇺🇸", Nokian:"🇫🇮", Hankook:"🇰🇷", Dunlop:"🇬🇧", Falken:"🇯🇵", Toyo:"🇯🇵"
};

export const WIDTHS  = ["155","175","185","195","205","215","225","235","245","255","265","275","285","295","305"];
...
export const BRANDS_LIST = [
  ...
  "Nokian","Hankook","Dunlop","Falken","Toyo","Kumho",
  "Yokohama","Vredestein","BFGoodrich","Cooper","Άλλη μάρκα"
];
...
export const FUEL_COLORS = {
  A:"#166534", B:"#15803d", C:"#92400e", D:"#991b1b", E:"#7f1d1d"
};

export const WET_COLORS = {
  A:"#1e40af", B:"#1d4ed8", C:"#7e22ce", D:"#9d174d", E:"#7f1d1d"
};

export const BLANK = {
  brand:"", name:"", width:"", aspect:"", rim:"", type:"",
  price:"", stock:"", fuel:"A", wet:"A", noise:"70", load:"91",
  speed:"V", description:""
};
