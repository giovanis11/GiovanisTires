...
const STYLE = `
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .view-btn { background:#1a1a1a; border:1px solid #2a2a2a; border-radius:4px; padding:5px 10px; cursor:pointer; color:var(--gray-light); font-size:12px; transition:all .15s; }
